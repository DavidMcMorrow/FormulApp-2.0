        ...
        bt_go.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                /*if(!et_u.getText().toString().equals("") && !et_v.getText().toString().equals("") &&
                    ...
                    initial = et_u.getText().toString();
                    end = et_v.getText().toString();
                    acc = et_a.getText().toString();
                    dist = et_s.getText().toString();
                    time = et_t.getText().toString();

                    if(TextUtils.isEmpty(initial)){
                        u = -999;
                    }else{u= Double.parseDouble(et_u.getText().toString());}

                    if(TextUtils.isEmpty(end)){
                        vel = -999;
                    }else{vel= Double.parseDouble(et_v.getText().toString());}

                    if(TextUtils.isEmpty(acc)){
                        a = -999;
                    }else{a= Double.parseDouble(et_a.getText().toString());}

                    if(TextUtils.isEmpty(dist)){
                        s = -999;
                    }else{s= Double.parseDouble(et_s.getText().toString());}

                    if(TextUtils.isEmpty(time)){
                        t = -999;
                    }else{t= Double.parseDouble(et_t.getText().toString());}
